...
class ContinuousDqnMlpModel(torch.nn.Module):
    """Multilayer Perceptron. For use with Continuous DQN agent. It uses epsilongreedy exploration
    ...
    def forward(self, observation, prev_action, prev_reward):
        ...
        lead_dim, T, B, img_shape = infer_leading_dims(observation, 0)
