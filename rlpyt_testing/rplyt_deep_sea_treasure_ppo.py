...
from rlpyt.models.pg.catmlp_model import CatMlpPgModel
...
def build_and_train(run_nr = 0):
    ...
    config = {}
    name = "deep_sea_treasure_ppo: " + DeepSeaTreasureEnv.__class__.__name__
